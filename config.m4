...
if test "$PHP_XDEBUG" != "no"; then
  ...
  XDEBUG_LIB_SOURCES="src/lib/usefulstuff.c src/lib/compat.c src/lib/crc32.c src/lib/hash.c src/lib/headers.c src/lib/lib.c src/lib/llist.c src/lib/log.c src/lib/set.c src/lib/str.c src/lib/timing.c src/lib/var.c src/lib/var_export_html.c src/lib/var_export_line.c src/lib/var_export_text.c src/lib/var_export_xml.c src/lib/xml.c"
  ...
  if test "$PHP_XDEBUG_SSL" = "yes"; then
    ...
    BEARSSL_EC_SOURCES="lib/bearssl/src/ec/ec_all_m31.c lib/bearssl/src/ec/ec_c25519_m64.c lib/bearssl/src/ec/ec_p256_m64.c lib/bearssl/src/ec/ec_prime_i31.c lib/bearssl/src/ec/ec_secp256r1.c lib/bearssl/src/ec/ec_secp384r1.c lib/bearssl/src/ec/ec_secp521r1.c lib/bearssl/src/ec/ecdsa_atr.c lib/bearssl/src/ec/ecdsa_i31_bits.c lib/bearssl/src/ec/ecdsa_i31_vrfy_asn1.c lib/bearssl/src/ec/ecdsa_i31_vrfy_raw.c"
    BEARSSL_HASH_SOURCES="lib/bearssl/src/hash/multihash.c lib/bearssl/src/hash/sha2small.c"
    BEARSSL_INT_SOURCES="lib/bearssl/src/int/i31_add.c lib/bearssl/src/int/i31_bitlen.c lib/bearssl/src/int/i31_decmod.c lib/bearssl/src/int/i31_decode.c lib/bearssl/src/int/i31_encode.c lib/bearssl/src/int/i31_fmont.c lib/bearssl/src/int/i31_iszero.c lib/bearssl/src/int/i31_modpow.c lib/bearssl/src/int/i31_montmul.c lib/bearssl/src/int/i31_muladd.c lib/bearssl/src/int/i31_ninv31.c lib/bearssl/src/int/i31_rshift.c lib/bearssl/src/int/i31_sub.c lib/bearssl/src/int/i31_tmont.c lib/bearssl/src/int/i32_div32.c lib/bearssl/src/int/i62_modpow2.c"
    ...
    BEARSSL_RSA_SOURCES="lib/bearssl/src/rsa/rsa_default_pkcs1_vrfy.c lib/bearssl/src/rsa/rsa_default_pub.c lib/bearssl/src/rsa/rsa_i62_pkcs1_vrfy.c lib/bearssl/src/rsa/rsa_i62_pub.c lib/bearssl/src/rsa/rsa_pkcs1_sig_unpad.c"
