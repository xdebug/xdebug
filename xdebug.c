...
PHP_INI_BEGIN()
	...
	STD_PHP_INI_BOOLEAN("xdebug.force_display_errors", "0",             PHP_INI_ALL,    OnUpdateBool,   force_display_errors, zend_xdebug_globals, xdebug_globals)
	STD_PHP_INI_ENTRY("xdebug.force_error_reporting", "0",              PHP_INI_ALL,    OnUpdateLong,   force_error_reporting, zend_xdebug_globals, xdebug_globals)
