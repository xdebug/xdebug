...
$data = file_get_contents(dirname(__FILE__) . '/bug00838.inc');
...
-> run -i 3
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="run" transaction_id="3" status="break" reason="ok"><xdebug:message filename="file:///tmp/xdebug-dbgp-test.php" lineno="19"></xdebug:message></response>

-> property_get -i 4 -n $a
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="property_get" transaction_id="4"><property name="$a" fullname="$a" address="" type="object" classname="A" children="1" numchildren="3" page="0" pagesize="32"><property name="_instance" fullname="$a::_instance" facet="static protected" address="" type="null"></property><property name="_a1" fullname="$a-&gt;_a1" facet="protected" address="" type="null"></property><property name="_a2" fullname="$a-&gt;_a2" facet="protected" address="" type="null"></property></property></response>
