...
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="property_get" transaction_id="4"><property name="$a" fullname="$a" type="object" classname="A" children="1" numchildren="3" page="0" pagesize="32"><property name="_instance" fullname="$a::_instance" facet="static protected" type="null"></property><property name="_a1" fullname="$a-&gt;_a1" facet="protected" type="null"></property><property name="_a2" fullname="$a-&gt;_a2" facet="protected" type="null"></property></property></response>
