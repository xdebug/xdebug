...
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="property_get" transaction_id="7"><property name="$this-&gt;*P*private_prop" fullname="$this-&gt;*P*private_prop" address="" type="string" size="0" encoding="base64"><![CDATA[]]></property></response>
