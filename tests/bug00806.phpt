...
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="property_get" transaction_id="5"><property name="$x[&#39;a b&#39;]" fullname="$x[&#39;a b&#39;]" type="array" children="1" numchildren="2" page="0" pagesize="32"><property name="0" fullname="$x[&#39;a b&#39;][0]" type="int"><![CDATA[1]]></property><property name="1" fullname="$x[&#39;a b&#39;][1]" type="int"><![CDATA[2]]></property></property></response>

-> property_get -i 6 -n "$x[\"a b\"]" -d 0 -c 0 -p 0
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="property_get" transaction_id="6"><property name="$x[&quot;a b&quot;]" fullname="$x[&quot;a b&quot;]" type="array" children="1" numchildren="2" page="0" pagesize="32"><property name="0" fullname="$x[&quot;a b&quot;][0]" type="int"><![CDATA[1]]></property><property name="1" fullname="$x[&quot;a b&quot;][1]" type="int"><![CDATA[2]]></property></property></response>
