...
$filename = realpath( dirname(__FILE__) . '/bug00566-2.inc' );
...
-> breakpoint_set -i 1 -n 7 -t conditional -f file://bug00566-2.inc -- JG1vZHVsZSA9PSB2aWV3cw==
<?xml version="1.0" encoding="iso-8859-1"?>
...
-> run -i 2
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" command="run" transaction_id="2" status="break" reason="ok"><xdebug:message filename="file://bug00566-2.inc" lineno="7"></xdebug:message></response>
