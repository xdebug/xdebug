--TEST--
Test for bug #2435: Xdebug does not handle 'muiltiple_sessions' dbgp feature correctly
--SKIPIF--
<?php
...
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" command="feature_get" transaction_id="3" feature_name="multiple_sessions" supported="1"><![CDATA[0]]></response>
