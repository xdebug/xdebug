--TEST--
Test for bug #2421: Crash with wrong option letter in DBGP and socket commands
--SKIPIF--
<?php
...
-> feature_set -i 1 -A wrongoptionchar
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="https://xdebug.org/dbgp/xdebug" command="feature_set" transaction_id="1"><error code="1"><message><![CDATA[parse error in command]]></message></error></response>
