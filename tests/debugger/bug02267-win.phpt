--TEST--
Test for bug #2267: Application slow when debugger is not running VS Code (Windows)
--SKIPIF--
<?php
...
[%d] [Step Debug] WARN: Creating socket for 'localhost:9119', WSAPoll success, but error: 0 (19).
[%d] [Step Debug] INFO: Connecting to localhost: yes
[%d] [Step Debug] WARN: Creating socket for 'localhost:9119', WSAPoll success, but error: 0 (19).
