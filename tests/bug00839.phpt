...
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="property_get" transaction_id="4"><property name="$a" fullname="$a" type="object" classname="A" children="1" numchildren="3" page="0" pagesize="32"><property name="_dumpTypeValues" fullname="$a::_dumpTypeValues" facet="static private" type="array" children="1" numchildren="3"></property><property name="prop1" fullname="$a-&gt;prop1" facet="protected" type="null"></property><property name="prop2" fullname="$a-&gt;prop2" facet="protected" type="null"></property></property></response>
