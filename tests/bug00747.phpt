--TEST--
Test for bug #747: Xdebug and SOAP Server conflicts (PHP 5.2.x)
--SKIPIF--
<?php if (!version_compare(phpversion(), "5.2", '>=')) echo "skip PHP 5.2.x needed\n"; ?>
<?php if (!version_compare(phpversion(), "5.3", '<')) echo "skip PHP 5.2.x needed\n"; ?>
--INI--
