...
%w%f %w%d      >=> NULL
%w%f %w%d     -> Closure::fromCallable($call%s = [0 => class ReflectionClass { public $name = 'stdClass' }, 1 => 'newInstanceWithoutConstructor']) %sbug01896.php:5
%w%f %w%d      >=> class Closure { public $this = class ReflectionClass { public $name = 'stdClass' } }
