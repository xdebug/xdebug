...
%w%f %w%d         -> Test->testFunc($args = array (0 => 'test1', 1 => 'test2')) %strace_with_magic_call_method_and_contents.php:7
%w%f %w%d           -> array_sum($ar%s = array (0 => 'test1', 1 => 'test2')) %strace_with_magic_call_method_and_contents.php:10
