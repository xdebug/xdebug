...
%w%f %w%d       -> strrev('view') %sbug00566-001.php:12
%w%f %w%d        >=> 'weiv'
%w%f %w%d       -> strrev('views') %sbug00566-001.php:14
%w%f %w%d        >=> 'sweiv'
%w%f %w%d      >=> NULL
%w%f %w%d     -> loadMod($module = 'test') %sbug00566-001.php:18
%w%f %w%d       -> strrev('test') %sbug00566-001.php:5
%w%f %w%d        >=> 'tset'
%w%f %w%d       -> strrev('tests') %sbug00566-001.php:7
%w%f %w%d        >=> 'stset'
%w%f %w%d      >=> NULL
%w%f %w%d     -> loadMod($module = 'view') %sbug00566-001.php:19
%w%f %w%d       -> strrev('view') %sbug00566-001.php:5
%w%f %w%d        >=> 'weiv'
%w%f %w%d       -> strrev('views') %sbug00566-001.php:7
%w%f %w%d        >=> 'sweiv'
%w%f %w%d      >=> NULL
