...
%w%f %w%d     -> call_user_func_array:{%scall_user_func_array-002.php:7}($function%S = 'debug', $%s = [0 => 'foo', 1 => [0 => 1, 1 => 2]]) %scall_user_func_array-002.php:7
...
%w%f %w%d     -> call_user_func_array:{%scall_user_func_array-002.php:10}($function%S = 'debug', $%s = [0 => 'bar', 1 => 'bar']) %scall_user_func_array-002.php:10
