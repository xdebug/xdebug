...
<tr><th align='left' bgcolor='#f57900' colspan="5"><span style='background-color: #cc0000; color: #fce94f; font-size: x-large;'>( ! )</span> %srror: Call to undefined function poo() in /%s/stacktrace_html_4.php on line <i>4</i></th></tr>
