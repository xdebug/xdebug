...
%w%f %w%d   2. trigger_error($message = 'four', $error_type = 512) %sforce_error_reporting-display_errors-002.php:4
...
Call Stack:
%w%f %w%d   1. {main}() %sforce_error_reporting-display_errors-002.php:0
%w%f %w%d   2. hex2bin($data = '4') %sforce_error_reporting-display_errors-002.php:6
