...
$b: (refcount=1, is_ref=0)=[1marray[22m([32m5[0m) {
  'a' =>
  (refcount=1, is_ref=0)=[1mint[22m([32m4[0m)
  'b' =>
  (refcount=2, is_ref=1)=[1mint[22m([32m5[0m)
  'c' =>
  (refcount=2, is_ref=0)=[1mint[22m([32m6[0m)
  [0] [0m=>[0m
  (refcount=1, is_ref=0)=[1mint[22m([32m8[0m)
  [1] [0m=>[0m
  (refcount=1, is_ref=0)=[1mint[22m([32m9[0m)
}

$b['a']: (refcount=1, is_ref=0)=[1mint[22m([32m4[0m)

$b['b']: (refcount=2, is_ref=1)=[1mint[22m([32m5[0m)

b[1]: (refcount=1, is_ref=0)=[1mint[22m([32m9[0m)

c: (refcount=2, is_ref=1)=[1mint[22m([32m5[0m)

d: (refcount=2, is_ref=0)=[1mint[22m([32m6[0m)
...
e: (refcount=1, is_ref=0)=[1mclass[22m [31mstdClass[0m#1 ([32m3[0m) {
  ...
  (refcount=1, is_ref=0)=[1marray[22m([32m2[0m) {
    ...
    (refcount=1, is_ref=0)=[1mint[22m([32m4[0m)
    'b' =>
    (refcount=1, is_ref=0)=[1mint[22m([32m42[0m)
  }
}
...
e->baz[0]: (refcount=1, is_ref=0)=[1mint[22m([32m4[0m)

e->baz['b']: (refcount=1, is_ref=0)=[1mint[22m([32m42[0m)
