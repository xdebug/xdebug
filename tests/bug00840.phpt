...
-> run -i 3
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="run" transaction_id="3" status="break" reason="ok"><xdebug:message filename="file:///tmp/xdebug-dbgp-test.php" lineno="31"></xdebug:message></response>

-> context_get -i 4 -d 0 -c 0
<?xml version="1.0" encoding="iso-8859-1"?>
<response xmlns="urn:debugger_protocol_v1" xmlns:xdebug="http://xdebug.org/dbgp/xdebug" command="context_get" transaction_id="4" context="0"><property name="$b" fullname="$b" address="" type="object" classname="B" children="0" numchildren="0" page="0" pagesize="32"></property><property name="$x" fullname="$x" address="" type="object" classname="A" children="1" numchildren="4" page="0" pagesize="32"><property name="_staticvar" fullname="$x::_staticvar" facet="static public" address="" type="null"></property><property name="var_1" fullname="$x-&gt;var_1" facet="protected" address="" type="null"></property><property name="var_2" fullname="$x-&gt;var_2" facet="protected" address="" type="null"></property><property name="var_3" fullname="$x-&gt;var_3" facet="protected" address="" type="null"></property></property></response>
