...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "..\php5" /I "..\php5\Zend" /I "..\php5\TSRM" /I "..\php5\main" /D "WIN32" /D "COMPILE_DL_XDEBUG" /D ZTS=1 /D HAVE_XDEBUG=1 /D ZEND_DEBUG=0 /D "NDEBUG" /D "_WINDOWS" /D "ZEND_WIN32" /D "PHP_WIN32" /D "HAVE_EXECUTE_DATA_PTR" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=php4ts.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\php_xdebug.pdb" /machine:I386 /out:"$(OUTDIR)\php_xdebug.dll" /implib:"$(OUTDIR)\php_xdebug.lib" /libpath:"..\php5\Release_TS" /libpath:"..\php5\Release_TS_Inline" /libpath:"..\php5\Release_TS" 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\php5" /I "..\php5\Zend" /I "..\php5\TSRM" /I "..\php5\main" /D ZEND_DEBUG=1 /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "COMPILE_DL_XDEBUG" /D ZTS=1 /D "ZEND_WIN32" /D "PHP_WIN32" /D HAVE_XDEBUG=1 /D "HAVE_EXECUTE_DATA_PTR" /Fp"$(INTDIR)\xdebug.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
